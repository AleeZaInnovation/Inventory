...
// Users Route //
Route::group(['as'=>'users.','prefix'=>'users', 'namespace'=>'Backend'], 
   function(){
...
// Supplier Route //
Route::group(['as'=>'supplier.', 'prefix'=>'supplier','namespace'=>'Backend'], function(){
...
// Unit Route //
Route::group(['as'=>'unit.', 'prefix'=>'unit','namespace'=>'Backend'], function(){
...
// Products Route //
Route::group(['as'=>'products.', 'prefix'=>'products','namespace'=>'Backend'], function(){
...
// Purchase Route //
Route::group(['as'=>'purchase.', 'prefix'=>'purchase','namespace'=>'Backend'], function(){
...
// Invocie Route //
Route::group(['as'=>'invoice.', 'prefix'=>'invoice','namespace'=>'Backend'], function(){
...
// Stock Route //
Route::group(['as'=>'stock.', 'prefix'=>'stock','namespace'=>'Backend'], function(){
